...
Description: "Test script for the ANS.5 user story. Searching for messages with a failed outcome"
...
* test[=].description = "user story ANS5 search for the created PatientDeliveryStatus object on the SUT with failed outcome"
...
* test[=].description = "user story ANS5 search for the created PatientDeliveryStatus object on the SUT with a successful outcome"
* test[=].action[+].operation.type = http://terminology.hl7.org/CodeSystem/testscript-operation-codes#search
* test[=].action[=].operation.resource = #AuditEvent
