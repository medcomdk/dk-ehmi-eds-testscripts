...
Description: "Test script for the ANS.2 use case. Searching for a specific message type"
...
* test[=].description = "Use case ANS2 create PatientDeliveryStatus object on the SUT in order to search for it later"
...
* test[=].description = "Use case ANS2 search for the created PatientDeliveryStatus object on the SUT with ehmiMessageType"
...
* test[=].description = "Use case ANS2 search for the created PatientDeliveryStatus object on the SUT with an invalid message type. Not expecting to find it"
* test[=].action[+].operation.type = http://terminology.hl7.org/CodeSystem/testscript-operation-codes#search
* test[=].action[=].operation.resource = #AuditEvent
